...
h1.firstElementChild.style.backgroundColor = '';
h1.lastElementChild.style.backgroundColor = '';
...
message.innerHTML= 'We use cookies for improve functionally and analytics. <button class="btn btn--close-cookie">Got it!</button>';
header.prepend(message);
//header.append(message);
//header.befor(message);
